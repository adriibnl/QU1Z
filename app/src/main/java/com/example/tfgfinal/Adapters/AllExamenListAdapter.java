...
import com.example.tfgfinal.DoExamActivity;
...
public class AllExamenListAdapter extends BaseAdapter {
    List<Examen> result;
    Context context;
    UsuariosDAO uDAO= new UsuariosDAO();
    private static LayoutInflater inflater= null;
    public AllExamenListAdapter(AllCuestionariosActivity activity, List<Examen> lista) {
        result = lista;
        context = activity;
        ...
        View rowView;
            ...
            rowView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(v.getContext(), DoExamActivity.class);
                    intent.putExtra("IdExamen",result.get(position).getId());
